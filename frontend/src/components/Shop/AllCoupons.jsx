                ...
                <form onSubmit={handleSubmit} aria-required={true}>
                  ...
                  <div>
                    <input
                      ...
                      // value="Create"
                      value="Créer"
                      className="mt-2 appearance-none cursor-pointer block w-full px-3 h-[35px] border border-gray-300 rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                    />
                  </div>
                </form>
              </div>
